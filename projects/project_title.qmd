...
Aneuploidy, or the presence of an abnormal number of chromosomes, is frequently observed in developmental disorders and cancer. Trisomy 12 (T12), a common chromosomal gain in cultured human induced pluripotent stem cells (iPSCs), has been associated with enhanced proliferation and stemness. iPSCs offer a powerful model to investigate such genomic alterations due to their capacity for self-renewal and differentiation.

In this project, we analyze transcriptomic changes associated with T12 in iPSCs to understand how gene dosage impacts cellular behavior. These insights are critical for ensuring genomic integrity in iPSC-based applications, particularly in regenerative medicine and disease modeling.

![](trisomy.png){fig-align="center" width="60%"}


## 2 Procedure

I performed bulk RNA sequencing (RNA-seq) on human induced pluripotent stem cells (iPSCs) with disomic and trisomic chromosome 12 to investigate transcriptomic differences associated with gene dosage. Total RNA was extracted from both cell types and sequenced using high-throughput methods. The resulting data were processed and analyzed to identify differentially expressed genes between trisomic and disomic chromosome 12 iPSCs.
![](Bulk.png){fig-align="center" width="80%"}
...
## 4 Glimpse at the RNA-seq Data

I have loaded the CSV file using read_csv() and use head() and glimpse() to confirm successful import and examine the structure of the dataset.

The dataset BulkRNAseq_with_Chr.csv contains normalized gene expression values, log₂ fold changes, adjusted p-values, and chromosome annotations for over 12,000 genes from disomic and trisomic iPSCs.
...
## 5 Summarize & Interpret Dataset

## 🔍 5.1 How many genes are upregulated or downregulated in trisomic iPSCs?
...
## 6 Is there a clear clustering of iPSCs by karyotype (trisomic vs. disomic) in the principal component space?

## 🔍 6.1 Prep the Data & Build the PCA Recipe
```{r}
...
## 🔍 6.3 Plot the Percent of Variance
...
## 7 Which genes on Chromosome 12 are most up/downregulated?

## 🔍 7.1 Volcano plot of ch-12 
```{r}
...
## 🔍 7.2 What are the top 10 most dysregulated genes on Trisomic Chr12?
...
![Stem cell trisomy meme](last.png){fig-align="center" width="30%"}
